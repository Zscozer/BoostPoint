...
class Model(nn.Module):
    def __init__(self, points=1024, class_num=40, embed_dim=64, groups=1, res_expansion=1.0,
        ...
        self.act = get_activation(activation)
        self.classifier_g2 = nn.Sequential(
        ...
        self.classifier_b1 = nn.Sequential(
            nn.Linear(last_channel, 512),
            nn.BatchNorm1d(512),
            self.act,
            nn.Dropout(0.5),
        ...
        self.classifier_b2 = nn.Sequential(
            nn.Linear(last_channel, 512),
            nn.BatchNorm1d(512),
            self.act,
            nn.Dropout(0.5),
        ...
        self.classifier_b3 = nn.Sequential(
            nn.Linear(last_channel, 512),
            nn.BatchNorm1d(512),
            self.act,
            nn.Dropout(0.5),
        ...
        self.classifier_b4 = nn.Sequential(
            nn.Linear(last_channel, 512),
            nn.BatchNorm1d(512),
            self.act,
            nn.Dropout(0.5),
        ...
        self.classifier_b5 = nn.Sequential(
            nn.Linear(last_channel, 512),
            nn.BatchNorm1d(512),
            self.act,
            nn.Dropout(0.5),
    ...
    def forward(self, x,zeros=None):
        ...
        x_g2 = self.classifier_g2(x)
        
        
        x_b1 = self.classifier_b1(x)
        # x_b1 = F.log_softmax(x_b1, -1)

        x_b2 = self.classifier_b2(x)
        # x_b2 = F.log_softmax(x_b2, -1)

        x_b3 = self.classifier_b3(x)
        ...
        g_0 = self.classifier_g2[0].weight
        # g_1 = self.classifer_g2[1].weight
        g_4 = self.classifier_g2[4].weight
        # g_5 = self.classifer_g2[5].weight
        g_8 = self.classifier_g2[8].weight
        # print("g_4", g_4.shape)
        b_0 = weight_stack(self.classifier_b1[0].weight, self.classifier_b2[0].weight, self.classifier_b3[0].weight,
                           self.classifier_b4[0].weight, self.classifier_b5[0].weight)
        ...
        b_4 = weight_stack(self.classifier_b1[4].weight, self.classifier_b2[4].weight, self.classifier_b3[4].weight,
                           self.classifier_b4[4].weight, self.classifier_b5[4].weight)
        ...
        b_8 = weight_stack(self.classifier_b1[8].weight, self.classifier_b2[8].weight, self.classifier_b3[8].weight,
                           self.classifier_b4[8].weight, self.classifier_b5[8].weight)
        # print("b_4",b_4.shape)
