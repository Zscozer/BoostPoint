...
from data import ModelNet40_dat
...
def main():
    ...
    checkpoint = torch.load(
        '/home/zhg/project/paper_project/checkpoint/pmlp_new_l/pmlp_debias_bs/new_checkpoints/model_best_avg_acc_0.959126_acc_0.966578.pth',
        map_location={'cuda:3': 'cuda:0'})
    del checkpoint['model_state_dict']['module.embedding.net.0.weight']
    del checkpoint['model_state_dict']['module.classifier_g2.8.weight']
    del checkpoint['model_state_dict']['module.classifier_g2.8.bias']
    del checkpoint['model_state_dict']['module.classifier_b1.8.bias']
    del checkpoint['model_state_dict']['module.classifier_b1.8.weight']
    del checkpoint['model_state_dict']['module.classifier_b2.8.bias']
    del checkpoint['model_state_dict']['module.classifier_b2.8.weight']
    del checkpoint['model_state_dict']['module.classifier_b3.8.bias']
    del checkpoint['model_state_dict']['module.classifier_b3.8.weight']
    del checkpoint['model_state_dict']['module.classifier_b4.8.bias']
    del checkpoint['model_state_dict']['module.classifier_b4.8.weight']
    del checkpoint['model_state_dict']['module.classifier_b5.8.bias']
    del checkpoint['model_state_dict']['module.classifier_b5.8.weight']
    ...
    train_loader = DataLoader(ModelNet40_dat(args,partition='train', num_points=args.num_points), num_workers=args.workers,
                              batch_size=args.batch_size, shuffle=True, drop_last=False)
    test_loader = DataLoader(ModelNet40_dat(args,partition='test', num_points=args.num_points), num_workers=args.workers,
    ...
    # scheduler = CosineAnnealingLR(optimizer, args.epoch, eta_min=0, last_epoch=start_epoch - 1)
